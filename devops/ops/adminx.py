...
from .models import  UserInfo,HostInfo,HardWareInfo,UserLock,PushCodeEvent,TopContServer, IDC, Host, MaintainLog, HostGroup, AccessRecord
import hashlib
import xadmin
...
class MainDashboard(object):
    widgets = [
        [
            ...
            {"type": "chart", "model": "ops.accessrecord", "chart": "user_count",
             "params": {"_p_date__gte": "2013-01-08", "p": 1, "_p_date__lt": "2013-01-29"}},
            {"type": "list", "model": "ops.host", "params": {"o": "-guarantee_date"}},
        ],
        [
...
#xadmin.site.register(HardWareInfo)
#xadmin.site.register(UserLock)
#xadmin.site.register(PushCodeEvent)
#xadmin.site.register(TopContServer)
