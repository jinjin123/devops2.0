# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2017-11-01 23:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shell_log', models.TextField(max_length=500)),
                ('data', models.TextField(max_length=500)),
                ('push_user', models.CharField(max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alive', models.CharField(blank=True, max_length=256)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alive', models.IntegerField(choices=[(0, 'dead'), (1, 'alive'), (2, 'check')], default=0)),
            ],
        ),
        migrations.CreateModel(
            name='UserLock',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shell', models.TextField(max_length=500)),
        ...
        migrations.AddField(
            model_name='history',
            name='webhook_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='webhook', to='ops.WebHook'),
        ),
    ]
